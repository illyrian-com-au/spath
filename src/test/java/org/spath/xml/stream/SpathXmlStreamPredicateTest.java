...
public class SpathXmlStreamPredicateTest extends TestCase {
    ...
    public void testAttributeEquals() throws XMLStreamException {
        ...
        SpathStreamEngine engine = createSpathEngine("<amount type='decimal'>10.25</amount>");
        engine.add(amount);
    ...
    public void testAndAttributeEquals() throws XMLStreamException {
        ...
        SpathStreamEngine engine = createSpathEngine("<amount type='decimal' currency='USD'>10.25</amount>");
        engine.add(amount);
    ...
    public void testStarAttributeNotEquals() throws XMLStreamException {
        ...
        SpathStreamEngine engine = createSpathEngine("<amount type='decimal' currency='AUD'>10.25</amount>");
        engine.add(amount);
    ...
    public void testAttributeEqualsNumber() throws XMLStreamException {
        ...
        SpathStreamEngine engine = createSpathEngine("<item amount='10.25'>Lunch</item>");
        engine.add(item);
        engine.add(amount);
    ...
    public void testStarAttributeNotEqualsNumber() throws XMLStreamException {
        ...
        SpathStreamEngine engine = createSpathEngine("<item amount='10.00'>Lunch</item>");
        engine.add(item);
        engine.add(amount);
    ...
    public void testStarAttributeLessThanNumber() throws XMLStreamException {
        ...
        SpathStreamEngine engine = createSpathEngine(SHOES);
        engine.add(item);
        engine.add(element);
